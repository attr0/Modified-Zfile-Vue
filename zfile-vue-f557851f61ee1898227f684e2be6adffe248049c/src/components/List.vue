    ...
    <div id="List">
        ...
        <el-table
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <div v-if="scope.row.type === 'FILE'">
                        ...
                        <el-tooltip class="item" effect="dark" content="复制链接" placement="right">
                            <i @click.stop="copyDownloadlink(scope.row)" class="el-icon-copy-document operator-btn"></i>
                        </el-tooltip>
                    </div>
                </template>
            </el-table-column>
            ...
            <el-table-column
                    ...
                    min-width="15%">
                <template slot="header" slot-scope="scope">
                    <i class="el-icon-coin" style="margin-right: 0px"></i>
                    <span>大小</span>
                </template>
            </el-table-column>
        ...
        <v-contextmenu ref="contextmenu">
            ...
            <v-contextmenu-item @click="copyDownloadlink(rightClickRow)" v-show="rightClickRow.type === 'FILE'">
